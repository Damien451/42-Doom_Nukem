...
/*   Updated: 2020/02/21 17:08:53 by dacuvill         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	while (++i < 64)
	{
		...
		while (++j < 64)
		{
			if (!(((unsigned int*)texture->pixels)
				...
				data->lib.image[(i + pos.y) * WIDTH + j + frame + pos.x] = 0xff0000;
