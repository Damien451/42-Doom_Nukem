...
void			test(t_doom *data)
{
	...
	read(fd, data->lib.textures_block[5], 128 * 4 * 128);
	close(fd);
	fd = open("/sgoinfre/goinfre/Perso/dacuvill/new_blocks_binaries/19.binary", O_RDONLY);
	read(fd, data->lib.textures_block[6], 128 * 4 * 128);
	close(fd);
	fd = open("/sgoinfre/goinfre/Perso/dacuvill/new_blocks_binaries/20.binary", O_RDONLY);
	read(fd, data->lib.textures_block[7], 128 * 4 * 128);
	close(fd);
	fd = open("/sgoinfre/goinfre/Perso/dacuvill/new_blocks_binaries/21.binary", O_RDONLY);
	read(fd, data->lib.textures_block[8], 128 * 4 * 128);
	close(fd);
	fd = open("/sgoinfre/goinfre/Perso/dacuvill/new_blocks_binaries/22.binary", O_RDONLY);
	read(fd, data->lib.textures_block[9], 128 * 4 * 128);
	close(fd);
	fd = open("/sgoinfre/goinfre/Perso/dacuvill/new_blocks_binaries/31.binary", O_RDONLY);
	read(fd, data->lib.textures_block[10], 128 * 4 * 128);
	close(fd);
	fd = open("/sgoinfre/goinfre/Perso/dacuvill/new_blocks_binaries/33.binary", O_RDONLY);
	read(fd, data->lib.textures_block[11], 128 * 4 * 128);
	close(fd);
	fd = open("/sgoinfre/goinfre/Perso/dacuvill/new_blocks_binaries/34.binary", O_RDONLY);
	read(fd, data->lib.textures_block[12], 128 * 4 * 128);
	close(fd);
	fd = open("/sgoinfre/goinfre/Perso/dacuvill/new_blocks_binaries/32.binary", O_RDONLY);
	read(fd, data->lib.textures_block[13], 128 * 4 * 128);
	close(fd);
	fd = open("/sgoinfre/goinfre/Perso/dacuvill/new_blocks_binaries/25.binary", O_RDONLY);
	read(fd, data->lib.textures_block[14], 128 * 4 * 128);
	close(fd);
	fd = open("/sgoinfre/goinfre/Perso/dacuvill/new_blocks_binaries/28.binary", O_RDONLY);
	read(fd, data->lib.textures_block[15], 128 * 4 * 128);
	close(fd);
	fd = open("/sgoinfre/goinfre/Perso/dacuvill/new_blocks_binaries/27.binary", O_RDONLY);
	read(fd, data->lib.textures_block[16], 128 * 4 * 128);
	close(fd);
	fd = open("/sgoinfre/goinfre/Perso/dacuvill/new_blocks_binaries/26.binary", O_RDONLY);
	read(fd, data->lib.textures_block[17], 128 * 4 * 128);
	close(fd);
	fd = open("/sgoinfre/goinfre/Perso/dacuvill/new_blocks_binaries/29.binary", O_RDONLY);
	read(fd, data->lib.textures_block[18], 128 * 4 * 128);
	close(fd);
	fd = open("/sgoinfre/goinfre/Perso/dacuvill/new_blocks_binaries/30.binary", O_RDONLY);
	read(fd, data->lib.textures_block[19], 128 * 4 * 128);
	close(fd);
	fd = open("/sgoinfre/goinfre/Perso/dacuvill/new_blocks_binaries/24.binary", O_RDONLY);
	read(fd, data->lib.textures_block[20], 128 * 4 * 128);
	close(fd);
	fd = open("/sgoinfre/goinfre/Perso/dacuvill/new_blocks_binaries/14.binary", O_RDONLY);
	read(fd, data->lib.textures_block[21], 128 * 4 * 128);
	close(fd);
	fd = open("/sgoinfre/goinfre/Perso/dacuvill/new_blocks_binaries/13.binary", O_RDONLY);
	read(fd, data->lib.textures_block[22], 128 * 4 * 128);
	close(fd);
	fd = open("/sgoinfre/goinfre/Perso/dacuvill/new_blocks_binaries/10.binary", O_RDONLY);
	read(fd, data->lib.textures_block[23], 128 * 4 * 128);
	close(fd);
	fd = open("/sgoinfre/goinfre/Perso/dacuvill/new_blocks_binaries/16.binary", O_RDONLY);
	read(fd, data->lib.textures_block[24], 128 * 4 * 128);
	close(fd);
	fd = open("/sgoinfre/goinfre/Perso/dacuvill/new_blocks_binaries/18.binary", O_RDONLY);
	read(fd, data->lib.textures_block[25], 128 * 4 * 128);
	close(fd);
	fd = open("/sgoinfre/goinfre/Perso/dacuvill/new_blocks_binaries/17.binary", O_RDONLY);
	...
	close(fd);
	fd = open("/sgoinfre/goinfre/Perso/dacuvill/new_blocks_binaries/15.binary", O_RDONLY);
	read(fd, data->lib.textures_block[29], 128 * 4 * 128);
	close(fd);
	fd = open("/sgoinfre/goinfre/Perso/dacuvill/new_blocks_binaries/23.binary", O_RDONLY);
	...
	close(fd);
	fd = open("/sgoinfre/goinfre/Perso/dacuvill/new_blocks_binaries/35.binary", O_RDONLY);
	...
	close(fd);
	fd = open("/sgoinfre/goinfre/Perso/dacuvill/new_blocks_binaries/38.binary", O_RDONLY);
	read(fd, data->lib.textures_block[35], 128 * 4 * 128);
	close(fd);
	fd = open("/sgoinfre/goinfre/Perso/dacuvill/new_blocks_binaries/39.binary", O_RDONLY);
	read(fd, data->lib.textures_block[36], 128 * 4 * 128);
	close(fd);
	fd = open("/sgoinfre/goinfre/Perso/dacuvill/new_blocks_binaries/36.binary", O_RDONLY);
	read(fd, data->lib.textures_block[37], 128 * 4 * 128);
	close(fd);
	fd = open("/sgoinfre/goinfre/Perso/dacuvill/new_blocks_binaries/37.binary", O_RDONLY);
