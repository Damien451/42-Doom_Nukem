...
all				: $(SDLDIR) SDL_text/ttf_build SDL2_mixer-2.0.4 textures/all_img.bin
	@make $(NAME)

$(NAME)			: $(OBJS)

	@make -C $(LIBDIR)
	@$(CC) $(CFLAGS) $(DEBUG) $(OPTI) -lpthread -lm -ldl -lz -o $@ $^ $(LIBDIR)/libft.a $(LIBSDL)
...
$(OBJDIR)/%.o	: $(SRCDIR)/%.c | $(OBJDIR)
	...
	@$(CC) $(CFLAGS) $(DEBUG) $(OPTI) -I $(INCDIR) $(INCSDL) \
		-I $(LIBDIR) -MMD -o $@ -c $<
...
textures/all_img.bin :
	cd textures && sh all_img.sh
